<%-- 
    Document   : cadastroCabecalho
    Created on : 26/04/2017, 17:06:16
    Author     : vinim
--%>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h1 class="page-header">Gerenciamento de Indicadores </h1> </center>

				<div class="removeMessages"></div>

				<button class="btn btn-default pull pull-right" data-toggle="modal" data-target="#addMember" id="addMemberModalBtn">
					<span class="glyphicon glyphicon-plus-sign"></span>	Adicionar Indicador
				</button>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><span class="glyphicon glyphicon-plus-sign"></span>	Adicionar Indicador</h4>
	      </div>
	      ...
	      <div class="modal-body">
	      	<div class="messages"></div>
                        ...
                        <div class="form-group"> <!--/here teh addclass has-error will appear -->
                          <label for="name" class="col-sm-2 control-label">Indicador</label>
                          <div class="col-sm-10"> 
                            <input type="text" class="form-control" id="nome" name="nome" placeholder="Indicador">
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="editMemberModal">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><span class="glyphicon glyphicon-edit"></span> Editar Indicador</h4>
	      </div>
		...
		<form class="form-horizontal" action="atualizar" method="POST" id="updateMemberForm" >	      
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> <!--/here teh addclass has-error will appear -->
                          <label for="editNome" class="col-sm-2 control-label">Indicador</label>
                          <div class="col-sm-10"> 
                            <input type="text" class="form-control" id="editNome" name="nome" placeholder="Indicador">
                              <!-- here the text will apper  -->
                          </div>
                        </div>
                         <div class="form-group"> <!--/here teh addclass has-error will appear -->
